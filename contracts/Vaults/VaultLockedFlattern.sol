...
// File: contracts/Vaults/Interfaces/IDistributable.sol
...
// File: contracts/IGlobalMasterChef.sol
...
// File: contracts/Modifiers/RewarderRestriction.sol
...
// File: contracts/Modifiers/DepositoryRestriction.sol
...
// File: contracts/Vaults/VaultLocked.sol
...
contract VaultLocked is IDistributable, Ownable, ReentrancyGuard, DepositoryRestriction, RewarderRestriction {
    ...
    {
        while(depositInfo[user].length > 0 && depositInfo[user][0].nextWithdraw < block.timestamp)
        {
