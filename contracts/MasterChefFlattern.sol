...
// File: contracts/Helpers/IMintNotifier.sol
...
// File: contracts/Helpers/IMinter.sol
...
// File: contracts/Modifiers/DevPower.sol
...
// File: contracts/Tokens/NativeToken.sol
...
// File: contracts/Modifiers/Trusted.sol
...
// File: contracts/Helpers/IPathFinder.sol
...
// File: contracts/Helpers/TokenAddresses.sol
...
// File: contracts/MasterChefInternal.sol
...
contract MasterChef is Ownable, DevPower, ReentrancyGuard, IMinter, Trusted {
    ...
    modifier onlyVault() {
        require(_msgSender() == vaultAddr, "Vault: caller is not the vault");
        _;
    }
    ...
    function deposit(address _account, uint256 _pid, uint256 _amount) public nonReentrant onlyVault(){
    ...
    function withdraw(address _account, uint256 _pid, uint256 _amount) public nonReentrant onlyVault(){
    ...
    function emergencyWithdraw(uint256 _pid) public nonReentrant onlyVault(){
        UserInfo storage user = userInfo[_pid][msg.sender];
    ...
    function setVaultContract(address _account) public onlyOwner {
        vaultAddr = _account;
    }
}